...
def convert_master(scandir, action="all", verbosity=0, metayaml=None, formatter=True):
    conv = Converter(scandir, action, verbosity, metayaml, formatter)
    conv.start()
...
if __name__ == "__main__":
    ...
    convert_master(args.scandir, args.action, args.verbosity, args.metayaml, args.formatter)
